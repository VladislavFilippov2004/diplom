            ...
            <div className='portfolio__personal-info'>
                <div className='portfolio__personal-info_text-content'>
                    ...
                    <div className='portfolio__personal-info_social-network'>
                        <a href='https://instagram.com/vvfwf?utm_medium=copy_link' target="blank" className='main__description-text'>Instagram</a>
                        <a href='https://github.com/VladislavFilippov2004' target="blank" className='main__description-text'>Github</a>
                    </div>
                </div>
